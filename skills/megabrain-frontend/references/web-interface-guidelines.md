...
Source: Vercel Labs, github.com/vercel-labs/web-interface-guidelines, commit e3d624baaf29dc1fc645aff3e38f03e564d2d6b1, AGENTS.md.
License: MIT.
Adaptation: this provenance wrapper was added; upstream guidance below is verbatim.
This pinned local copy is the only Web Interface Guidelines source for normal skill execution; do not fetch updates at runtime.
-->
