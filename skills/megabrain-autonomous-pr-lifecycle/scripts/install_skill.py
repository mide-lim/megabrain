...
ARTIFACTS = {
    ...
    Path("scripts/github_app_user_attribution.py"): 0o700,
    Path("scripts/bootstrap_user_attribution.py"): 0o700,
    ...
    Path("scripts/authenticated_observe_ci.py"): 0o700,
}
VERSIONED_SOURCE_FILES = set(ARTIFACTS) | {
    ...
    Path("tests/test_github_app_user_attribution.py"),
