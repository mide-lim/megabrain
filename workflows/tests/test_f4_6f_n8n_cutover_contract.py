...
F6_TC2C_MGB030_SHA256 = "7d6e01ed5966b6a07f47f2bff3e787d6fbac03860180095fb7ab1726bd19dbc8"
...
def test_cutover_document_preserves_historical_artifacts_and_current_tc2c_mgb030_is_pinned() -> None:
    document = text(CUTOVER)

    assert hashlib.sha256(MGB020.read_bytes()).hexdigest() == MGB020_SHA256
    assert hashlib.sha256(MGB030.read_bytes()).hexdigest() == F6_TC2C_MGB030_SHA256
