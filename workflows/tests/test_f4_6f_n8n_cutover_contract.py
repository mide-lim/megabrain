...
F6_TC2A_MGB030_SHA256 = "7e7aee11321c09bfe32fd32ad50bd9fdf69eb6433de4efa42a9d9f5db870be01"
...
def test_cutover_document_preserves_historical_artifacts_and_current_tc2a_mgb030_is_pinned() -> None:
    document = text(CUTOVER)

    assert hashlib.sha256(MGB020.read_bytes()).hexdigest() == MGB020_SHA256
    assert hashlib.sha256(MGB030.read_bytes()).hexdigest() == F6_TC2A_MGB030_SHA256
