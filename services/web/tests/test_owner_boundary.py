...
def test_health_auth_routes_and_legacy_html_transition_routes_remain_public(monkeypatch) -> None:
    monkeypatch.setattr(main, "fetch_reels", lambda *_: ([], False))
    ...
    assert client.get("/reels/42").status_code == 404
